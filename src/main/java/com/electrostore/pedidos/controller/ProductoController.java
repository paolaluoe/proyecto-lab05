...
@PutMapping("/{id}")
public ResponseEntity<Producto> actualizar(@PathVariable Long id, @RequestBody Producto
producto) {
...
public ResponseEntity<List<Producto>> listarPorCategoriaNamed(@PathVariable String
categoria) {
...
public ResponseEntity<List<Producto>> listarPorPrecioMaximo(@RequestParam BigDecimal
max) {
